    ...
    <>
      ...
      <section className="furniture-hero relative flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-4 py-24 md:py-40 animate-fade-in">
          <div className="max-w-3xl">
            {/* Eyebrow text */}
            <p className="text-primary font-medium mb-4 tracking-wide">LUXURY FURNITURE COLLECTION</p>
            ...
            <div className="relative mb-8">
              <p className="text-lg md:text-xl text-white/90 max-w-xl leading-relaxed">
                Discover our curated collection of premium, handcrafted furniture 
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              <Link href="/products?category=Living+Room" legacyBehavior={false}>
        ...
        <div className="container px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            <div className="flex items-center justify-center md:justify-start gap-3">
              ...
              <span className="text-sm font-medium">Premium Quality Craftsmanship</span>
            </div>
            <div className="flex items-center justify-center gap-3">
              <Truck className="h-6 w-6 text-primary" />
              <span className="text-sm font-medium">Free Delivery & Assembly</span>
            </div>
            <div className="flex items-center justify-center md:justify-end gap-3">
              <Clock className="h-6 w-6 text-primary" />
              <span className="text-sm font-medium">5-Year Furniture Warranty</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-background">
        <div className="container mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-playfair">Curated Collections</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explore our carefully selected furniture collections designed to create harmony in every space
            </p>
            ...
            <Link href="/products?category=Living+Room" className="group block">
              <div className="relative aspect-[4/5] overflow-hidden rounded-lg shadow-md mb-4">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  ...
                  <p className="text-white/80 text-sm mb-4">Timeless elegance for your everyday sanctuary</p>
            ...
            <Link href="/products?category=Bedroom" className="group block">
              <div className="relative aspect-[4/5] overflow-hidden rounded-lg shadow-md mb-4">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  ...
                  <p className="text-white/80 text-sm mb-4">Serene designs for restful retreats</p>
                  <div className="flex items-center text-primary font-medium text-sm transition-transform duration-300 transform group-hover:translate-x-2">
                    <span>Explore collection</span>
                    <ArrowRight size={16} className="ml-2" />
                  </div>
            ...
            <Link href="/products?category=Dining" className="group block">
              <div className="relative aspect-[4/5] overflow-hidden rounded-lg shadow-md mb-4">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  ...
                  <p className="text-white/80 text-sm mb-4">Sophisticated spaces for memorable gatherings</p>
                  <div className="flex items-center text-primary font-medium text-sm transition-transform duration-300 transform group-hover:translate-x-2">
                    <span>Explore collection</span>
                    <ArrowRight size={16} className="ml-2" />
                  </div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 font-playfair">Craftsmanship Meets Modern Design</h2>
              <div className="gold-accent mb-8"></div>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                At FancyFurnish, we believe that exceptional furniture is born from a harmonious blend of traditional craftsmanship and contemporary vision. Each piece in our collection is thoughtfully designed to bring enduring beauty and functionality to your space.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                <div>
                  <h3 className="text-lg font-semibold mb-2">Sustainable Materials</h3>
                  <p className="text-sm text-muted-foreground">Responsibly sourced woods and eco-friendly production processes</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">Timeless Design</h3>
                  <p className="text-sm text-muted-foreground">Pieces that transcend trends and remain relevant for years</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">Expert Construction</h3>
                  <p className="text-sm text-muted-foreground">Meticulous attention to detail and precision engineering</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">Comfort Focus</h3>
                  <p className="text-sm text-muted-foreground">Ergonomic designs that prioritize your comfort and wellbeing</p>
                </div>
              </div>
              <Link href="/products" legacyBehavior={false}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="relative aspect-square overflow-hidden rounded-lg shadow-md">
                  <Image 
                    src="https://images.unsplash.com/photo-1594620302200-6a762955a855?auto=format&fit=crop&q=80" 
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-playfair">Latest Additions</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-24 px-4 bg-card">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 font-playfair">Join Our Community</h2>
          ...
          <p className="text-xs text-muted-foreground mt-4">
            By subscribing, you agree to our Privacy Policy and consent to receive updates from FancyFurnish
          </p>
        </div>
      </section>
    </>
